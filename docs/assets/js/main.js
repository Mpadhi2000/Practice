  ...
  function (t, e, n) {
    ...
    function Et (t) {
      var e = t.store,
        ...
        a = e.getState(),
        u = a.ixInstances,
        c = a.ixSession.hasBoundaryNodes && r ? _.getClosestElement(r, w) : null
    ...
    r.define(
      ...
      (t.exports = function (t) {
        ...
        function y (e, n) {
          var r = t.data(n, p)
          r &&
            (r.links && r.links.each(E.reset), r.panes && r.panes.each(E.reset))
        }
        function I (e, r) {
          var i = p.substr(1) + '-' + e,
            o = t(r),
...
$(function () {
  let formCon = $('#ContactUsForm')

  $('#ContactUsTerms', formCon).click(function () {
    if ($(this).is(':checked')) {
      $('#ContactUsSubmitBtn', formCon).prop('disabled', false)
    } else {
      $('#ContactUsSubmitBtn', formCon).prop('disabled', true)
    }
  })
  ...
  $(formCon).submit(function (e) {
    ...
    $(formCon).fadeOut('slow', e => {
      $('#ContactFormThankYou').fadeIn('slow')
    })
  })
})
...
(function($) {
	...
	// 	if (video) {
	// 	  var videoPlayer = $(event.relatedTarget).find('video').get(0);
	// 	  videoPlayer.src = video;
	// 	  videoPlayer.play();
	// 	}
	//   });
	  
	//   // Check if the first carousel item is active on page load
	//   var firstItem = $('#myCarousel .carousel-item').first();
	//   if (firstItem.hasClass('active')) {
	// 	var video = firstItem.data('video');
	// 	if (video) {
	// 	  var videoPlayer = firstItem.find('video').get(0);
	// 	  videoPlayer.src = video;
	// 	  videoPlayer.play();
	// 	}
	//   }
